...
def load_cifar10_dataset():
    train_X = np.load(r"C:\Users\302-15\Desktop\새 폴더\DL3\data\cifar10_train_X.npy")
    train_y = np.load(r"C:\Users\302-15\Desktop\새 폴더\DL3\data\cifar10_train_y.npy")
    test_X = np.load(r"C:\Users\302-15\Desktop\새 폴더\DL3\data\cifar10_test_X.npy")
    test_y = np.load(r"C:\Users\302-15\Desktop\새 폴더\DL3\data\cifar10_test_y.npy")
...
def build_cnn_model(img_shape, num_classes=10):
    ...
    model.add(layers.Conv2D(filters=64, kernel_size=(3,3), padding='same',activation='relu', strides=(2,2)))
    model.add(layers.Conv2D(filters=64, kernel_size=(3,3), padding='same',activation='relu', strides=(2,2)))
    model.add(layers.MaxPool2D(pool_size=(2,2)))
